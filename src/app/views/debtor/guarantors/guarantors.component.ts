...
export class GuarantorsComponent implements OnInit {
    ...
    constructor(private objectsService : ObjectsService, private router : Router, private http : HttpClient, private translate : TranslateService, private snotifyService : SnotifyService) {}
    ...
    ngOnInit(): void { // should be list visible?
        ...
        this.http.get<any>(`${
            environment.apiUrl
        }/get/contract/` + this.contract.id + `/guarantors`, {}).pipe(first()).subscribe((data) => {
